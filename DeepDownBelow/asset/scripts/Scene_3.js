class Caves extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.spritesheet("Dridrill", "/asset/sprites/drill.png", { frameWidth: 32, frameHeight: 32 });
        ...
        // - - - add tilset - - -
        this.load.spritesheet("Tiles", "/asset/sprites/tileSet/proceduralGen.png", { frameWidth: 16, frameHeight: 16 });
    ...
    addTile(x, y) {
        ...
        if (this.biome == 0 || this.biome == 1 || this.biome == 2) {
            if (Phaser.Math.Between(0, this.ore_Rarity + (- x / this.map_Length)) == 0) {
                this.ground.add(this.physics.add.sprite(x, y, "Tiles").setSize(16, 16).setFrame(Phaser.Math.Between(0, 3)))
                this.ore.add(this.physics.add.sprite(x, y, "Tiles").setSize(16, 16).setFrame(34).setDepth(1))// ore
            }
            else {
                this.ground.add(this.physics.add.sprite(x, y, "Tiles").setSize(16, 16).setFrame(Phaser.Math.Between(0, 3))) // rock
            }
        }
        if (this.biome == 3 || this.biome == 4 || this.biome == 5) {
            if (Phaser.Math.Between(0, (this.ore_Rarity + (- x / this.map_Length)) * 2) == 0) {
                this.ground.add(this.physics.add.sprite(x, y, "Tiles").setSize(16, 16).setFrame(Phaser.Math.Between(6, 9)))
                if (Phaser.Math.Between(0, 1) == 1) {
                    this.ore.add(this.physics.add.sprite(x, y, "Tiles").setSize(17, 17).setFrame(34).setDepth(1))// ore
                }
                else { this.ore.add(this.physics.add.sprite(x, y, "Tiles").setSize(16, 16).setFrame(35)) } // ore
            }
            else {
                this.ground.add(this.physics.add.sprite(x, y, "Tiles").setSize(16, 16).setFrame(Phaser.Math.Between(6, 9))) // rock
            }
        }
        if (this.biome == 6 || this.biome == 7 || this.biome == 8) {
            if (Phaser.Math.Between(0, this.ore_Rarity + (- x / this.map_Length)) == 0) {
                this.ground.add(this.physics.add.sprite(x, y, "Tiles").setSize(16, 16).setFrame(Phaser.Math.Between(14, 17))) // rock
                this.ore.add(this.physics.add.sprite(x, y, "Tiles").setSize(16, 16).setFrame(35).setDepth(1))// ore
            }
            else {
                this.ground.add(this.physics.add.sprite(x, y, "Tiles").setSize(16, 16).setFrame(Phaser.Math.Between(14, 17))) // rock
            }
        ...
        if (this.biome == 9 || this.biome == 10) {
            this.ground.add(this.physics.add.sprite(x, y, "Tiles").setSize(16, 16).setFrame(Phaser.Math.Between(22, 25))) // rock
            if (Phaser.Math.Between(0, this.ore_Rarity + (- x / this.map_Length)) == 0) {
                this.ore.add(this.physics.add.sprite(x, y, "Tiles").setSize(16, 16).setFrame(36).setDepth(1))// ore
            }
            else {
                this.ground.add(this.ground.add(this.physics.add.sprite(x, y, "Tiles").setSize(16, 16).setFrame(Phaser.Math.Between(22, 25)))) // rock
            }
        }
